 ...
 */
public class UserFindLetterActivity extends BaseActivity implements IUserFindLetterContract.IUserFindLetterView {
    ...
    public void initData() {
        ...
        if (getIntent().getIntExtra("Type", 0) == 1) {
            ((FragUserFindLetterPresenterImpl) presenter).setItem(1);
        }
    }
    ...
    public void getLetters(ShowMyLetterBody showMyLetterBody) {
        presenter.getLetterList(showMyLetterBody);
    }
