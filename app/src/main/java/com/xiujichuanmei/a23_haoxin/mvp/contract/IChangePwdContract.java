 ...
 */
public class IChangePwdContract {
    public interface IChangePwdView extends BaseView<IChangePwdPresenter> {

        PowerfulEditText getmActChangePwdEtOldPwd();

        PowerfulEditText getmActChangePwdEtNewPwd();

        PowerfulEditText getmActChangePwdEtNewPwdAgain();
    ...
    public interface IChangePwdPresenter extends BasePresenter<IChangePwdView> {
