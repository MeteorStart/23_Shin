...
public class RevealFollowButton extends FrameLayout {
    ...
    private void init() {
        mDrawable = getResources().getDrawable(R.drawable.icon_gerenzhuye_guanzhu);
        ...
        mUnFollowTv.setCompoundDrawables(mDrawable, mDrawable, mDrawable, mDrawable);
        ...
        mFollowTv.setCompoundDrawables(mDrawable, null, null, null);

        addView(this.mFollowTv);

        mFollowTv.setPadding(0, 0, 0, 0);
        mUnFollowTv.setPadding(0, 0, 0, 0);
