...
import com.xiujichuanmei.a23_haoxin.mvp.view.view.DragPhotoView;

import java.util.List;

/**
 * @name: ShowPhotoActivity
 * @description: 点击图片查看大图页面
 * @version: 1.0
 * @date: 2017/6/8 10:40
 * @company:
 * @author: Meteor
...
//        }
        ...
        for (int i = 0; i < mPhotoViews.length; i++) {
            ...
            Glide.with(this).load(mList.get(i)).asBitmap().into(mPhotoViews[i]);
        ...
        mViewPager.getViewTreeObserver()
                .addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        final DragPhotoView photoView = mPhotoViews[mViewPager.getCurrentItem()];
    ...
    private void performExitAnimation(final DragPhotoView view, float x, float y, float w, float h) {
        ...
        ObjectAnimator mAnimatorAlpha = ObjectAnimator.ofFloat(view, "alpha", 1.0f, 0.0f);
        mAnimatorAlpha.setDuration(500);
