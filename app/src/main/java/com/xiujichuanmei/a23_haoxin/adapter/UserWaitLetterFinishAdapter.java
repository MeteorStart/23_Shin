 ...
 */
public class UserWaitLetterFinishAdapter extends BaseQuickAdapter<DemandInfo.MyDemandBean, BaseViewHolder> {

    public UserWaitLetterFinishAdapter(@LayoutRes int layoutResId, @Nullable List<DemandInfo.MyDemandBean> data) {
